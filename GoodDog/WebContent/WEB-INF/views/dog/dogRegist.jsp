					...
					<form role="form" class="form-horizontal" action="regist" method="post">						
						...
						<div class="input-group mb-3">
						  ...
						  <div class="form-group row">
							 <label for="dogName" class="col-sm-3" style="font-size:0.9em;" >
							 	<span style="color:red;font-weight:bold;">*</span>이름</label>	
							<div class="col-sm-9 input-group input-group-sm">
								<input name="dogName" 
								type="text" class="form-control" id="dogName" >								
							</div>								
						</div>
						<div class="form-group row">
							<label for="dogBreed" class="col-sm-3" style="font-size:0.9em;">
								<span style="color:red;font-weight:bold;">*</span>견종</label>
							<div class="col-sm-9 input-group-sm">								
								<input class="form-control" name="dogBreed" class="form-control" id="dogBreed"/>
							</div>
							
						</div>
						<div class="form-group row">
							<label for="dogGender" class="col-sm-3" style="font-size:0.9em;" >성별</label>
							<div class="col-sm-9">
						...
						<div class="form-group row">
							<label for="adoptYn" class="col-sm-3" style="font-size:0.9em;" >상태</label>
							<div class="col-sm-9">
						...
						<div class="form-group row">
							<label for="dogFeature" class="col-sm-3" style="font-size:0.9em;">소개</label>
							<div class="col-sm-9 input-group-sm">
								<input name="dogFeature" type="email" class="form-control" id="email" />
							</div>
						</div>
...
<script>
	...
	function upload_go(){
		...
		$.ajax({
		    ...
		    success:function(data){
	          ...
	          $('form[role="form"]  input[name="dogPic"]').val(data);	    	  
	    	  alert("사진이 업로드 되었습니다.");
		    },
	...
	function regist_go(){
		...
		if(!$('input[name="dogName"]').val()){
		  alert("이름은 필수 기재사항입니다.");
		  return;
		}
	    if(!$('input[name="dogBreed"]').val()){
		  alert("견종은 필수 기재사항입니다.");
		  return;
	    }
	    if(!$('select[name="dogGender"]').val()){
		  alert("성별은 필수 선택사항입니다.");
		  return;
		}
	    if(!$('input[name="dogFeature"]').val()){
			  alert("소개는 필수 기재사항입니다.");
			  return;
		}
