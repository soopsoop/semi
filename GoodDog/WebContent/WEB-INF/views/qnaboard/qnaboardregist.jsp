	  		...
	  		<div class="row md-2">
	  			...
	  			<div class="col-sm-6">
			        ...
			        <li class="breadcrumb-item">
			        	<a href="#">
				        	<i class="fa fa-dashboard">게시글 작성</i>
				        </a>
			        </li>
...
<!-- 						<div class="form-group row">
						...
						<div class="form-group row">
							<label for="qnaTitle" class="col-sm-3" style="font-size:0.9em;">
								<span style="color:red;font-weight:bold;">*</span>제 목</label>
							<div class="col-sm-9 input-group-sm">								
								<input class="form-control" name="qnaTitle" type="text" class="form-control" id="qnaTitle"
						...
						<div class="form-group row">
							<label for="qnaContent" class="col-sm-3" style="font-size:0.9em;">
								<span style="color:red;font-weight:bold;">*</span>내 용</label>
							<div class="col-sm-9 input-group-sm">								
								<input class="form-control" name="qnaContent" type="text" class="form-control" id="qnaContent"
